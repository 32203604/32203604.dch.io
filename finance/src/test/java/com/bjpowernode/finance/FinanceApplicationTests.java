...
public class FinanceApplicationTests {
    ...
    @Autowired
	UserChangeMoneyMapper  selectByPrimaryKeyWithUserAndChangeMoney;
...
//		System.out.println(ucm.getId());
		UserChangeMoney userChangeMoney = userChangeMoneyMapper.selectByPrimaryKeyWithUserAndChangeMoney(2);
